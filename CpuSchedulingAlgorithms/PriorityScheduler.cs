...
/// </summary>
public class PriorityScheduler : IProcessScheduler
{
    ...
    public PriorityScheduler(ArrivalSchedule schedule)
    {
    ...
    public bool Proceed()
    {
        ...
        if (Now <= schedule.EndTime)
        {
            ...
            {
                readyQueue.Enqueue(new ProcessControlBlock(process, arrivalTime: Now), process.Priority);
            }
        }
